...
import pl.tau.sosuno.db.BookDAO;
...
public class BookDAOTest {
    ...
    public void setup() throws SQLException {
        ...
        PreparedStatement addPersonStmt = connection.prepareStatement(
                "INSERT INTO Book (title, authors, year, genrres, publisher) VALUES (?, ?, ?, ?, ?, ?)",
    ...
    @Test
    public void testGet() {
        Book book = bookManager.get(expectedDbState.get(1).getId());
        ...
        assertEquals(expectedDbState.get(1).getYear(),book.getId());
